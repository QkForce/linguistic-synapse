  ...
  return (
    ...
    >
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={styles.monthlySessionsHeader}>
          <Text
            style={[styles.monthlySessionsTitle, { color: colors.label }]}
            children="Айлық журнал"
          />
          <Text
            style={[
              styles.totalSessions,
...
const styles = StyleSheet.create({
  ...
  monthlySessionsHeader: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginTop: 16,
    marginHorizontal: 28,
  },
  monthlySessionsTitle: {
    fontSize: 10,
    fontWeight: "700",
    textTransform: "uppercase",
  },
